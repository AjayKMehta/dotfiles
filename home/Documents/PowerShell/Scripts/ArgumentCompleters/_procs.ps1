...
Register-ArgumentCompleter -Native -CommandName 'procs' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'procs' {
            ...
            [CompletionResult]::new('--text', '--text', [CompletionResultType]::ParameterName, 'Use plain text search mode (default)')
            [CompletionResult]::new('--regex', '--regex', [CompletionResultType]::ParameterName, 'Use regex search mode (single PATTERN)')
            [CompletionResult]::new('--smart', '--smart', [CompletionResultType]::ParameterName, 'Use smart mode (auto-detect regex syntax)')
            ...
            [CompletionResult]::new('--gen-man-page', '--gen-man-page', [CompletionResultType]::ParameterName, 'Generate man page and write to stdout')
