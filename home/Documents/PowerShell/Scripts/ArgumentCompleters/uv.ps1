...
Register-ArgumentCompleter -Native -CommandName 'uv' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'uv;run' {
            ...
            [CompletionResult]::new('--only-dev', '--only-dev', [CompletionResultType]::ParameterName, 'Omit non-development dependencies')
        ...
        'uv;build' {
            ...
            [CompletionResult]::new('--project', '--project', [CompletionResultType]::ParameterName, 'Run the command within the given project directory')
            [CompletionResult]::new('--config-file', '--config-file', [CompletionResultType]::ParameterName, 'The path to a `uv.toml` file to use for configuration')
            [CompletionResult]::new('--all', '--all', [CompletionResultType]::ParameterName, 'Builds all packages in the workspace')
        ...
        'uv;publish' {
            [CompletionResult]::new('--publish-url', '--publish-url', [CompletionResultType]::ParameterName, 'The URL of the upload endpoint')
