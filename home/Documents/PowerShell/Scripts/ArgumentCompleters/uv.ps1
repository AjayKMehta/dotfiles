...
Register-ArgumentCompleter -Native -CommandName 'uv' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'uv;python' {
            ...
            [CompletionResult]::new('upgrade', 'upgrade', [CompletionResultType]::ParameterValue, 'Upgrade installed Python versions to the latest supported patch release (requires the `--preview` flag)')
