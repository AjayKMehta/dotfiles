...
Register-ArgumentCompleter -Native -CommandName 'uv' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'uv' {
            ...
            [CompletionResult]::new('audit', 'audit', [CompletionResultType]::ParameterValue, 'Audit the project''s lockfile for known vulnerabilities and unmaintained dependencies')
