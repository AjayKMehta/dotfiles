...
- **Comment-Based Help:** Include comment-based help for any public-facing function or cmdlet. Inside the function, add `<# ... #>` documentation comments with at least:
...
- **Consistent Formatting:**
  ...
  - Follow the rules specified in PSScriptAnalyzerSettings.psd1 if it exists.
